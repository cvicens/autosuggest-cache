...
function _populate() {
  ...
  client.zadd("durac", 0, "sku-43900");
  client.zadd("durac", 0, "sku-48530");
  client.zadd("durac", 0, "sku-127687");
  client.zadd("durac", 0, "sku-185230");
  ...
  client.zadd("duracell - a", 0, "sku-43900");
  client.zadd("duracell - a", 0, "sku-48530");
  client.zadd("duracell - a", 0, "sku-127687");
...
function searchProduct(name) {
  return new Promise(function(resolve, reject) {
    ...
    // ZRANGE name 0 -1
    client.zrange(name, 0, -1, function (err, replies) {
      if (err) {
  ...
  return new Promise(function(resolve, reject) {
    ...
    client.hmget('SKUs', skus, function (err, replies) {
      if (err) {
        ...
        resolve(replies.map((product) => JSON.parse(product)));
      }
    });
  });
}
